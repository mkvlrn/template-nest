...
type _CoercedEnvSchema_901555fb = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_901555fb> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_901555fb, 'port'>> {}
}
...
type _EnvSchemaAsStrings_901555fb = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_901555fb {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_901555fb {}
  }
}